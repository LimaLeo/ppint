...
public class MenuFrame extends JFrame {
	...
	public MenuFrame() {
		...
		JMenu fileMenu = new JMenu(bn.getString("tela2.file.jmenu")); // cria o
																		// menu
																		// File
																		// ou
																		// configura
															...
															// anônima
		{
			...
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(MenuFrame.this, bn.getString("tela2.about.message"),
						bn.getString("tela2.about.title.message"), JOptionPane.PLAIN_MESSAGE);
			} // fim do método actionPerformed
		} // fim da classe interna anônima
		); // fim da chamada para addActionListener

		JMenuItem exitItem = new JMenuItem(bn.getString("tela2.exit.jmenuitem")); // cria
																					// o
																					// item
																					// exit
		...
		JMenu formatMenu = new JMenu(bn.getString("tela2.format.jmenu")); // cria
																			// o
																			// menu
																			// Format
		formatMenu.setMnemonic('r'); // configura o mnemônico como r
		// array listando cores de string
		String colors[] = { bn.getString("tela2.colors.black"), bn.getString("tela2.colors.blue"),
				bn.getString("tela2.colors.red"), bn.getString("tela2.colors.green") };
		JMenu colorMenu = new JMenu(bn.getString("tela2.color.jmenu")); // cria
																		// o
																		// menu
																		// Color
		...
		JMenu fontMenu = new JMenu(bn.getString("tela2.font.jmenu")); // cria a
																		// fonte
																		// do
																		// menu
		...
		String styleNames[] = { bn.getString("tela2.fonts.bold"), bn.getString("tela2.fonts.italic") }; // nomes
																										// dos
																										// estilos
		...
		// idiomaMenu.setMnemonic('I'); // configura o mnemônic como I
		// // cria item de menu idioma
		// JMenuItem portuguesItems = new JMenuItem("Português");
		// portuguesItems.setMnemonic('P');// configura atalho
		//
		// idiomaMenu.add(portuguesItems); // adiciona o menu Font ao menu
		// Format
		// bar.add(idiomaMenu); // adiciona o menu Format à barra de menus
		// portuguesItems.addActionListener(new ActionListener() // classe
		// interna
		// // anônima
		// {
		// // exibe um diálogo de mensagem quando o usuário seleciona About...
		...
		// ); // fim da chamada para addActionListener
		//
		// JMenuItem francaiseItems = new JMenuItem("Française");
		// francaiseItems.setMnemonic('F');// configura atalho
		//
		// idiomaMenu.add(francaiseItems); // adiciona o menu Font ao menu
		// Format
		// francaiseItems.addActionListener(new ActionListener() // classe
		// interna
		// // anônima
		// {
		// // exibe um diálogo de mensagem quando o usuário seleciona About...
		...
		// italianoItems.addActionListener(new ActionListener() // classe
		// interna
		// // anônima
		// {
		// // exibe um diálogo de mensagem quando o usuário seleciona About...
